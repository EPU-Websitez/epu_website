...
const Page = () => {
  ...
  return (
    <div className="my-10 flex_center w-full flex-col gap-10 sm:px-0 px-3">
      ...
      <div className="w-full flex_start gap-20 relative">
        {locale === "en" && (
          <div className="md:w-1/2 w-[90%] z-10 md:relative absolute md:left-auto left-0 flex md:justify-end justify-start md:items-start items-center md:top-auto top-1/2 md:-translate-y-0 -translate-y-1/2 lg:px-0 px-3">
            <h1 className="lg:text-[52px] md:text-title text-titleNormal font-semibold md:text-secondary text-white max-w-[450px]">
              <span className="text-golden">Innovative</span> <br /> Research
              and Publications
            </h1>
          </div>
        )}
        {locale === "ku" && (
          <div className="md:w-1/2 w-[90%] z-10 md:relative absolute md:left-auto left-0 flex md:justify-end justify-start md:items-start items-center md:top-auto top-1/2 md:-translate-y-0 -translate-y-1/2 lg:px-0 px-3">
            <h1 className="lg:text-[52px] md:text-title text-titleNormal font-semibold md:text-secondary text-white max-w-[450px]">
              <span className="text-golden">توێژینەوە</span> <br /> و بڵاوکراوەی
              داهێنەرانە
            </h1>
          </div>
        )}
        {locale === "ar" && (
          <div className="md:w-1/2 w-[90%] z-10 md:relative absolute md:left-auto left-0 flex md:justify-end justify-start md:items-start items-center md:top-auto top-1/2 md:-translate-y-0 -translate-y-1/2 lg:px-0 px-3">
            <h1 className="lg:text-[52px] md:text-title text-titleNormal font-semibold md:text-secondary text-white max-w-[450px]">
              <span className="text-golden">الأبحاث</span> <br /> والمنشورات
              المبتكرة
            </h1>
          </div>
        )}
        ...
        <div className="lg:w-[1024px] w-full h-[60px] absolute left-1/2 md:bottom-10 bottom-2 z-10 -translate-x-1/2 flex_start">
          <div className="lg:w-[800px] md:w-[600px] w-full flex_center gap-5 bg-white bg-opacity-30 md:p-5 p-2 rounded-3xl">
      ...
      <div className="flex justify-center items-center sm:w-[500px] w-full h-[50px] relative bg-lightBorder rounded-2xl overflow-hidden gap-5 mt-10">
        <span
      ...
      <div className="grid md:grid-cols-2 grid-cols-1 w-full gap-5 max-w-[1040px]">
        ...
        >
          ...
          <div className="flex_start flex-col gap-4 text-secondary">
            <h2 className="md:text-base text-[10px]">
            ...
            <div className="flex_center py-1 px-3 gap-4 rounded-xl border border-lightBorder">
              <AiOutlineUser />
