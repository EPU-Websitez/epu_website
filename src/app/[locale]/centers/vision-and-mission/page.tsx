...
const Page = () => {
  ...
  return (
    <div className="w-full flex justify-center items-start mt-10 min-h-screen">
      <div className="max-w-[1024px] px-3 text-secondary flex_center flex-col gap-5 w-full">
        ...
        <div className="w-full lg:h-[500px] sm:h-[400px] h-[300px] relative mt-14">
        ...
        <div className="md:w-[720px] w-full sm:h-[50px] h-[35px] grid grid-cols-3 justify-center items-center bg-lightBorder text-secondary rounded-3xl">
