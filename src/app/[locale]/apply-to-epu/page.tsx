    ...
    <div className="my-10 flex_center w-full">
      <div className="max-w-[1024px] px-3 w-full flex_start flex-col gap-8">
        ...
        <div className="w-full sm:h-[410px] h-[225px] relative">
          ...
          <p className="z-10 absolute top-[30%] text-white ltr:left-[5%] rtl:right-[5%] font-semibold sm:text-base text-sm sm:max-w-[600px] max-w-[80%]">
            {t("text")}
          </p>
        </div>
        <div className="w-full flex_start flex-col lg:p-10 p-5 rounded-3xl gap-5 bg-gradient-to-r from-primary to-blue text-white">
          <span className="text-sm">{t("question")}</span>
          <h1 className="sm:text-titleNormal text-lg font-semibold relative">
            {t("why_apply")}
            <span className="absolute right-0 -bottom-2 w-[40%] h-[10px]">
              <Image
          ...
          <div className="flex_center lg:gap-8 gap-3 w-full sm:flex-row flex-col">
            <div className="flex_start flex-col gap-3 sm:w-auto w-full sm:border-none border-b border-b-white sm:pb-0 pb-4">
              <div className="flex_center gap-4">
                <PiGraduationCap className="lg:text-5xl sm:text-3xl text-5xl" />
                <p className="font-medium lg:text-base text-sm">
                  {t("reason_1")}
                </p>
              </div>
              <p className="sm:max-w-[250px] max-w-full lg:text-sm sm:text-xs text-sm text-justify opacity-75">
                {t("reason_text_1")}
              </p>
            </div>
            ...
            <div className="flex_start flex-col gap-3 sm:w-auto w-full sm:border-none border-b border-b-white sm:pb-0 pb-4">
              <div className="flex_center gap-4">
                <PiHandshake className="lg:text-5xl sm:text-3xl text-5xl" />
                <p className="font-medium lg:text-base text-sm">
                  {t("reason_2")}
                </p>
              </div>
            ...
            <div className="flex_start flex-col gap-3">
              <div className="flex_center gap-4">
                <TfiShine className="lg:text-5xl sm:text-3xl text-5xl" />
                <p className="font-medium lg:text-base text-sm">
                  {t("reason_3")}
                </p>
              </div>
        ...
        <div className="w-full bg-backgroundSecondary flex_start flex-col gap-8 sm:p-10 p-5 rounded-3xl border border-lightBorder">
