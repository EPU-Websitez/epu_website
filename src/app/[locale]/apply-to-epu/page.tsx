...
const Page = () => {
  ...
  const reasonIcons = [
    <PiGraduationCap key={1} className="lg:text-4xl sm:text-2xl text-4xl" />,
    <PiHandshake key={2} className="lg:text-4xl sm:text-2xl text-4xl" />,
    <TfiShine key={3} className="lg:text-4xl sm:text-2xl text-4xl" />,
  ];
